...
public class ItalianPizzaFragment extends Fragment {

    private FloatingActionButton btn_add_pizzas;

    private static final String URL_PRODUCTS = "http://192.168.1.68:81/CookingApp/MyApi/Pizza.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(getActivity(), "Fill in Details to Add Recipe For Italian Pizza", Toast.LENGTH_SHORT).show();
